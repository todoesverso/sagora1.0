...
CAboutDlg::CAboutDlg ( QWidget* parent ) : QDialog ( parent )
{
    ...
    txvCredits->setText (
        ...
        + tr ( "Autores: Esteban Calcagno, Nicolás Rodríguez Altieri, Diego Romero Mascaró. " )
        + "<p><span align='justify'>"+ APP_NAME
        + "Funciona en OSX (10.10 en adelante), Windows (8 en adelante), Linux x86-64/AMD64 64-bit y x86 32-bit y Raspbian, el sistema operativo de Raspberry Pi. </span></p><span>"
...
QString CAboutDlg::GetVersionAndNameStr ( const bool bWithHtml )
{
    ...
    strVersionText += tr ( "SAGORA, Version 1.0. Mayo 2020" );
...
*/
    ...
    plblAlias->setStyleSheet("    background-color: rgb(40, 40, 40);\nborder-color: rgb(0, 0, 0);\ncolor: rgb(255, 255, 255);");
    pGridLayout->addWidget ( plblAlias, 0, 0 );
    pedtAlias->setStyleSheet("    background-color: rgb(40, 40, 40);\nborder-color: rgb(0, 0, 0);\ncolor: rgb(255, 255, 255);");
    pGridLayout->addWidget ( pedtAlias, 0, 1 );

    plblInstrument->setSizePolicy ( QSizePolicy::Minimum, QSizePolicy::Expanding );
    plblInstrument->setStyleSheet("    background-color: rgb(40, 40, 40);\nborder-color: rgb(0, 0, 0);\ncolor: rgb(255, 255, 255);");
    pcbxInstrument->setStyleSheet("    background-color: rgb(40, 40, 40);\nborder-color: rgb(0, 0, 0);\ncolor: rgb(255, 255, 255);");
    ...
    butClose->setStyleSheet("    background-color: rgb(40, 40, 40);\nborder-color: rgb(0, 0, 0);\ncolor: rgb(255, 255, 255);");
                                               ...
                                               const QString&   strCentralServerAddress )
{
    ...
    {
    case AT_MANUAL:        return DEFAULT_SERVER_ADDRESS;
